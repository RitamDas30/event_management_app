  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Your digital tickets with QR codes</p>
      </div>
      ...
      {loading ? (
          ...
          {registrations.map((reg) => (
            <div key={reg._id} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white">
                ...
                <span className="text-xs bg-white/20 px-2 py-0.5 rounded-full">{reg.event.category}</span>
              </div>
              ...
              <div className="p-4">
                ...
                {reg.qrCode ? (
                  <div className="flex flex-col items-center py-4 border-t border-dashed border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Scan at event entrance</p>
                    <button
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 mt-2">Register for events to get your digital tickets</p>
          <Link to="/explore" className="mt-4 inline-block text-sm font-medium text-blue-600">
            Browse Events
          </Link>
        </div>
      )}
