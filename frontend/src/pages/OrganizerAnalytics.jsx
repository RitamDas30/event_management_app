        ...
        return barData.length > 0 ? (
          <ResponsiveContainer width="100%" height={320}>
            <LineChart data={barData}>
              ...
              <Line type="monotone" dataKey="registered" stroke="#4F46E5" strokeWidth={2.5} dot={{ fill: "#4F46E5", r: 4 }} name="Registered" />
        ...
        return revenueData.length > 0 ? (
          <ResponsiveContainer width="100%" height={320}>
            <AreaChart data={revenueData}>
              ...
              <Area type="monotone" dataKey="revenue" stroke="#10B981" fill="#10B981" fillOpacity={0.15} strokeWidth={2.5} dot={{ fill: "#10B981", r: 4 }} name="Revenue" />
            </AreaChart>
          </ResponsiveContainer>
        ) : (
